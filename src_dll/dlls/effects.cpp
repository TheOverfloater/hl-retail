...
{
	DEFINE_FIELD( CEnvELight, m_isActive, FIELD_BOOLEAN )
};

IMPLEMENT_SAVERESTORE( CEnvELight, CBaseEntity );
...
void CEnvELight::Spawn( void )
{
	...
	if(FStringNull(pev->targetname) || (pev->spawnflags & ELIGHT_SF_STARTON))
		m_isActive = true;
}
